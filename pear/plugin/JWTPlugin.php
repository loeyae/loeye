    ...
    public function process(Context $context, array $inputs)
    {
        ...
        if ($encryptData) {
            ...
            try {
                ...
                Utils::errorLog($e);
                $context->getResponse()->setStatusCode(PermissionException::TOKEN_EXPIRED, PermissionException::TOKEN_EXPIRED_MSG);
                ...
                Utils::errorLog($e);
                $context->getResponse()->setStatusCode(PermissionException::ACCESS_DENIED, PermissionException::TOKEN_INVALID_MSG);
